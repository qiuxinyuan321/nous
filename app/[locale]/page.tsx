        ...
        <ol className="mx-auto max-w-3xl space-y-6">
          {(['capture', 'refine', 'plan', 'focus', 'review'] as const).map((k, idx) => (
            <li key={k} className="flex gap-5">
              <span className="bg-ink-heavy text-paper-rice font-serif-en flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-sm">
                {idx + 1}
              </span>
              <div>
                <h3 className="font-serif-cn text-ink-heavy text-base font-medium">
