...
<div align="center">
<img src="./docs/screens-v2/relation-rail.png" alt="RelationRail 关联侧栏" width="100%" />
</div>

每个想法、笔记、复盘右侧有一条关联栏——**同主题的想法、指向它的任务、同源的对话、同时段的事件、AI 沉淀的相关记忆**，双向跳转。你在 Nous 里写的东西不再是孤岛。
...
<td width="50%">
<img src="./docs/screens-v2/refine.png" alt="苏格拉底对话" />
